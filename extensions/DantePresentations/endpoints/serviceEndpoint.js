...
function handler (e) {
  ...
  switch (obj.command) {
    ...
    case "stderr": { let ele =document.getElementById ("stderr-" + obj.num); ele.classList.add ("stderr-active"); ele.textContent += obj.data; ele.scrollTop = ele.scrollHeight; break; }

    case "stdout": { let ele =document.getElementById ("stdout-" + obj.num); ele.classList.add ("stdout-active"); ele.textContent += obj.data; ele.scrollTop = ele.scrollHeight; break; }

    case "cmd":    { let ele =document.getElementById ("cmd-" + obj.num); ele.textContent += obj.data; ele.scrollTop = ele.scrollHeight; break;    }
    ...
    case "close": { 
      console.warn ("will close event source");
      source.close();  break;}
